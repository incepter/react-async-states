...
export default function HydrationServer({context, exclude}: HydrationProps) {
...
function buildHydrationData(
  ...
  try {
    ...
    let assignment = `Object.assign(window.__ASYNC_STATES_HYDRATION_DATA__ || {}, ${JSON.stringify(states)})`
