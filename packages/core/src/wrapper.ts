...
function shouldRetry<T, E, A extends unknown[]>(
	attempt: number,
	retryConfig: RetryConfig<T, E, A>,
	error: E
): boolean {
...
function getRetryBackoff<T, E, A extends unknown[]>(
	attempt: number,
	retryConfig: RetryConfig<T, E, A>,
	error: E
): number {
